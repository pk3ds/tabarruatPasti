...
<template>
    <div class="min-h-screen bg-gradient-to-b from-emerald-50 to-white py-8 px-4 sm:px-6">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-emerald-100 overflow-hidden">
                ...
                <div class="p-6 sm:p-8">
                    ...
                    <!-- Submitted Details -->
                    <div v-if="submittedData" class="bg-emerald-50 rounded-xl p-6 mb-8 border border-emerald-200">
                        <h3 class="text-lg font-semibold text-emerald-800 mb-4 text-center">Butiran Permohonan</h3>

                        <div class="space-y-3">
                            <div class="flex justify-between items-start py-2 border-b border-emerald-200">
                                <span class="text-gray-600">Nama Pemohon</span>
                                <span class="font-semibold text-gray-800 text-right">{{ submittedData.nama_pemohon }}</span>
                            </div>

                            <div class="flex justify-between items-start py-2 border-b border-emerald-200">
                                <span class="text-gray-600">PASTI</span>
                                <span class="font-semibold text-gray-800 text-right">{{ submittedData.pasti }}</span>
                            </div>

                            <div class="py-2">
                                <span class="text-gray-600 block mb-2">Nama Arwah</span>
                                <ul class="space-y-1">
                                    <li v-for="(arwah, index) in submittedData.nama_arwah" :key="index" class="font-semibold text-gray-800 text-right">
                                        {{ index + 1 }}. {{ arwah }}
                                    </li>
                                </ul>
                            </div>
                    ...
                    <!-- Doa -->
                    <div class="bg-gradient-to-r from-amber-50 to-amber-100 rounded-xl p-6 mb-8 border border-amber-200 text-center">
                        <p class="text-amber-800 font-medium mb-2">Doa Untuk Arwah</p>
                    ...
                    <a
                        href="/"
                        class="block w-full py-4 px-6 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 text-center"
                    >
                        Mohon Lagi
                    </a>
                </div>
                ...
                <!-- Footer Decoration -->
                <div class="bg-emerald-50 px-6 py-4 text-center border-t border-emerald-100">
                    ...
                    <p class="text-xs text-emerald-600 mt-2">— Surah Al-Baqarah: 272</p>
                </div>
            </div>
